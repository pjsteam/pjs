...
\note{All benchmarks are performed using two different versions of Google Chrome (40.0.2214 and 41.0.2272) to be able to get an idea of the evolution of each feature.}

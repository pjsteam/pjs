...
\bmcode{http://jsperf.com/additional-sendingdata-comparison/2}{../../spikes/6.1/sendingAdditionalsSeqVsPar/jspBenchmark.js}

The results for the benchmark are displayed in Figure~\ref{fig:context-send}.
\img{Comparing small context message passing}{../../spikes/6.1/sendingAdditionalsSeqVsPar/jspBenchmark-all-browsers}{fig:context-send}

...
\note{The improvement shown in Figure~\ref{fig:func-key-vs-instance} will vary if the difference in character length between the key and the function's code does.}
